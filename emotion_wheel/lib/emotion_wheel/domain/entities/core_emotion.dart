import 'SecondaryEmotions.dart';
import 'TertiaryEmotions.dart';
...
var secondaryEmotions = <SecondaryEmotions>[];
    ...
    return CoreEmotion(id: id, name: name, isPositive: isPositive, secondaryEmotions: secondaryEmotions, tertiaryEmotions: tertiaryEmotions);
  }
